...
public class ProductController {
    ...
    public ResponseEntity<GetProductByIdResponse> getProductById(@PathVariable("productId") String productId) {
        ...
        return ResponseEntity.status(200).body(product.getByIdResponse());
    }
}
